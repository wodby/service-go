# Go service for Wodby

Use Go as a reusable component in applications managed by Wodby. This repository
contains the service manifests and referenced files used by the public Go
service in the Wodby catalog.
...
4. Reference `go` from your stack manifest.
